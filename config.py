...
class Settings:
    ...
    autonomy_web_research_enabled: bool
    autonomy_web_strategy_ideas: int
    autonomy_ai_variant_triage_enabled: bool
    autonomy_ai_variant_triage_target: int
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        autonomy_web_research_enabled=env_bool("AUTONOMY_WEB_RESEARCH_ENABLED", True),
        autonomy_web_strategy_ideas=env_int("AUTONOMY_WEB_STRATEGY_IDEAS", 24),
        autonomy_ai_variant_triage_enabled=env_bool(
            "AUTONOMY_AI_VARIANT_TRIAGE_ENABLED", True
        ),
        autonomy_ai_variant_triage_target=env_int(
