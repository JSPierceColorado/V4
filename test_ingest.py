...
def test_autonomy_defaults_are_live_unbounded_all_symbols(monkeypatch) -> None:
    for name in (
        ...
        "AUTONOMY_WEB_RESEARCH_ENABLED",
        "AUTONOMY_WEB_STRATEGY_IDEAS",
    ...
    assert settings.autonomy_web_research_enabled is True
    assert settings.autonomy_web_strategy_ideas == 24
